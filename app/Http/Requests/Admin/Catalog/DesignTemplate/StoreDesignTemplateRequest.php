...
class StoreDesignTemplateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'layers.*.layerId' => ['required', 'string'],
    ...
    public function messages(): array
    {
        return [
            ...
            'layers.*.layerId.required' => __('Each layer must have a unique layer ID.'),
